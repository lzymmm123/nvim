...
let g:coc_global_extensions = ['coc-json','coc-tsserver','coc-yank','coc-translator','coc-tasks','coc-snippets','coc-cmake','coc-lists','coc-python','coc-html','coc-markdownlint','coc-texlab','coc-explorer','coc-clangd','coc-rust-analyzer']
